...
public interface IntricationsEntities {
	...
	EntityType<MagicMissileEntity> MAGIC_MISSILE = createEntity("magic_missile", QuiltEntityTypeBuilder.<MagicMissileEntity>create(SpawnGroup.MISC, MagicMissileEntity::new).setDimensions(EntityDimensions.fixed(.5f,.5f)).maxChunkTrackingRange(128).build());
